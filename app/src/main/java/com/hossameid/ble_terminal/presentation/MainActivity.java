package com.hossameid.ble_terminal.presentation;
...
import com.hossameid.ble_terminal.databinding.ActivityMainBinding;
import com.hossameid.ble_terminal.presentation.terminal.TerminalActivity;
import com.hossameid.ble_terminal.utils.MACAddressValidator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void goToTerminalActivity(){
        Intent intent = new Intent(this, TerminalActivity.class);
        // Send the device to the next activity
        intent.putExtra("bluetooth_device", viewModel.getDevice());
    ...
    private void onConnectBtnClick() {
        ...
        if (!permissions.isEmpty()) {
            ...
            binding.deviceNameEditText.setError(null);

            String macAddress = Objects.requireNonNull(binding.macAddressEditText.getText()).toString();
            String name = Objects.requireNonNull(binding.deviceNameEditText.getText()).toString();

            if (macAddress.isEmpty() && name.isEmpty()) {
                binding.macAddressLayout.setError("Please enter a MAC address or a name");
                binding.deviceNameLayout.setError("Please enter a name or a MAC address");
                return;
            }
